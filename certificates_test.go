...
func TestCertificateLoader(t *testing.T) {
	...
	t.Run("should sign a string", func(t *testing.T) {
		signature, err := certificate.Sign("some data to sign", crypto.SHA256, xmldsig.ECDSAFormatConcatenated)
		require.NoError(t, err)
...
func TestECCertificateLoader(t *testing.T) {
	...
	t.Run("should sign payloads without error", func(t *testing.T) {
		signature, err := certificate.Sign("ec certificate payload", crypto.SHA256, xmldsig.ECDSAFormatConcatenated)
		require.NoError(t, err)
